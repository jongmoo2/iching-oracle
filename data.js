...
const HEXAGRAM_LINES_TEXT = {
    ...
    "2": {
        "0": "2.重地坤(중지곤)\n坤元亨利(곤원형리) : 곤은 원하고 형하고 리하고\n牝馬之貞(리빈마지정) : 암말의 정함이니,\n君子有攸往(군자유유왕) : 군자의 행하는 바이다.\n先迷(선미) : 먼저 하면 아득하고,\n後得主利(후득주리) : 뒤에 하면 얻으리니 이로움을 주관하게 되느니라.\n西南得朋(서남득붕) : 서남은 벗을 얻고,\n東北喪朋(동북상붕) : 동북은 벗을 잃으니,\n安貞吉(안정길) : 마음으로부터 곧게 하니 길하리라.",
    ...
    "12": {
        ...
        "1": "初六(초육) : 초육은\n拔茅茹(발모여) : 띠뿌리를 뽐음이라.\n以其彙貞吉亨(이기휘정길형) : 그 무리로써 바르게 함이니길해서 형통하니라.\n象曰(상왈) : 상에 가로대,\n拔茅貞吉(발모정길) : '발모정길'은\n志在君也(지재군야) : 뜻이 임금에 있음이라.",
