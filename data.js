...
const HEXAGRAM_LINES_TEXT = {
    "1": {
        "0": "1.重天乾(중천건)\n乾 元享利貞(건원형이정) : <건>은 크고 형통하고 이롭고 바르다.\n象曰(상왈) : 상에 이르기를 \n天行健(천행건) : 하늘의 운행이 굳건하니 \n君子以自強不息(군자이자강불식) : 군자는 이것으로써 스스로 굳세게 하여 쉬지 않는다.",
        "1": "初九(초구) :\n潛龍勿用(잠룡물용) : 잠긴 용이니 쓰지 말아라.\n象曰(상왈) :\n潛龍勿用(잠룡물용) : 잠룡물용이란\n陽在下也(양재하야) : 양이 아래에 있다는 것이고",
        "2": "九二(구이) :\n見龍在田利見大人(현룡재전리견대인) : 나타난 용이 밭에 있으니 대인을 봄이 이롭다.\n象曰(상왈) :\n見龍在田(현룡재전) : 현룡재전이란\n德施普也(덕시보야) : 덕을 베풀음이 넓다는 것이다.",
        "3": "九三(구삼) :\n君子終日乾乾夕惕若厲無咎(군자종일건건석척약려무구) : 군자가 종일토록 굳건히 하다가 저녁이 되어서는 두려운 마음으로 반성하면, 위태로우나 허물은 없을 것이다.\n象曰(상왈) :\n終日乾乾(종일건건) : 종일건건이란\n反復道也(반부도야) : 도를 반복한다는 것이다.",
        "4": "九四(구사) :\n或躍在淵無咎(혹약재연무구) : 혹 뛰어 올랐다가 다시 못에 돌아오면 허물이 없을 것이다.\n象曰(상왈) :\n或躍在淵(혹약재연) : 혹약재연이란\n進無咎也(진무구야) : 나아가도 허물이 없다는 것이다.",
        "5": "九五(구오) :\n飛龍在天利見大人(비룡재천리견대인) : 나는 용이 하늘에 있으니 대인을 봄이 이롭다.\n象曰(상왈) :\n飛龍在天(비룡재천) : 비룡재천이란\n大人造也(대인조야) : 대인이 만든다는 것이다.",
        "6": "上九(상구) :\n亢龍有悔(항룡유회) : 지나치게 높은 용이니 뉘우침이 있을 것이다.\n象曰(상왈) :\n亢龍有悔(항룡유회) : 항룡유회라는 것은\n盈不可久也(영불가구야) : 차서 가히 오래하지 못한다는 것이다."
    },
    "2": {
        "0": "2.重地坤(중지곤)\n坤 元亨利(곤원형리) : <곤>은 원하고 형하고 리하고\n牝馬之貞(리빈마지정) : 암말의 정함이니,\n君子 有攸往(군자유유왕) : 군자의 행하는 바이다.\n先迷(선미) : 먼저 하면 아득하고,\n後得 主利(후득주리) : 뒤에 하면 얻으리니 이로움을 주관하게 되느니라.\n西南得朋(서남득붕) : 서남은 벗을 얻고,\n東北喪朋(동북상붕) : 동북은 벗을 잃으니,\n安貞吉(안정길) : 마음으로부터 곧게 하니 길하리라.\n象曰(상왈) : 상에 이르기를 \n地勢坤(지세곤) : 땅의 형세가 곤이니 \n君子以厚德載物(군자이후덕재물) : 군자가 이로써 두터운 덕으로 만물을 싣느니라.",
        "1": "初六(초육) : 초육은\n履霜 堅冰至(리상견빙지) : 서리를 밟으면 굳은 얼음을 이르니니라.\n象曰(상왈) : 상에 이르기를\n履霜堅氷(리상견빙) : 이상견빙은\n陰始凝也(음시응야) : 음이 처음 엉김이니,\n馴致其道(순치기도) : 그 도를 길들여 이루어서 .\n至堅冰也(지견빙야) : 굳은 얼음에 이르게 하느니라",
        "2": "六二(육이) : 육이는\n直方大(직방대) : 곧고 모나고 큰지라,\n不習無不利(불습무불리) : 익히지 아니해도 이롭지 아니함이 없느니라.\n象曰(상왈) : 상에 이르기를,\n六二之動(육이지동) : 육이의 동함이\n直以方也(직이방야) : 곧고 방정하니,\n不習無不利(불습무불리) : 불습무불리는\n地道光也(지도광야) : 땅의 도가 빛남이니라.",
        "3": "六三(육삼) : 육삼은\n含章可貞(함장가정) : 빛나는 것을 머금어 가히 바르게 함이니,\n或從王事(혹종왕사) : 혹 왕의 일을 좇아서\n無成有終(무성유종) : 이름은 없으도 마침은 있느니라.\n象曰(상왈) : 상에 이르기를\n含章可貞(함장가정) : 빛남을 머금고 바르게 하나\n以時發也(이시발야) : 때에 따라서 발함이요,\n或從王事(혹종왕사) : 혹 왕을 따라 일을 함은\n知光大也(지광대야) : 앎이 빛나고 큼이라.",
        "4": "六四(육사) : 육사는\n括囊(괄낭) : 주머니를 매듯이 감추면\n無咎無譽(무구무예) : 허물이 없으며 명예로움도 없으리라.\n象曰(상왈) : 상에 이르기를\n括囊無咎(괄낭무구) : 괄낭무구는\n愼不害也(신불해야) : 신중하면 해롭지 아니한 것이다.",
        "5": "六五(육오) : 육오는\n黃裳元吉(황상원길) : 누런 치마면 크게 길하리라.\n象曰(상왈) : 상에 가로대\n黃裳元吉(황상원길) : 황상원길은\n文在中也(문재중야) : 문채가 가운데 있음이라",
        "6": "上六(상육) : 상육은\n龍戰于野(용전우야) : 용이 들에서 싸우니\n其血玄黃(기혈현황) : 그 피가 검고 누르도다.\n象曰(상왈) : 상에 가로대,\n龍戰于野(룡전우야) : 용이 들에서 싸움은\n其道窮也(기도궁야) : 그 도가 다함이다."
    },
    "3": {
        "0": "3.水雷屯(수뢰둔)\n屯(둔) : <둔>은\n元亨(원형) : 크게 형통하고\n利貞(리정) : 바르게 함이 이로우니,\n勿用有攸往(물용유유왕) : 스스로 나아가지 말고\n利建侯(리건후) : 제후를 세움이 이로우니라.\n象曰(상왈) : 상에 가로대,\n雲雷屯(운뢰둔) : 구름과 우뢰가 둔이니\n君子以經綸(군자이경륜) : 군자가 이로써 경륜하니라.",
        "1": "初九(초구) : 초구는\n磐桓(반환) : 머뭇거림이니,\n利居貞(리거정) : 바른데에 거처함이 이로우며\n利建侯(리건후) : 제후를 세움이 이로우니라.\n象曰(상왈) : 상에 가로대,\n雖磐桓(수반환) : 비록 머뭇거리나,\n志行正也(지행정야) : 뜻이 바른 것을 행하며,\n以貴下賤(이귀하천) : 귀함으로써 친한 데에 내리니\n大得民也(대득민야) : 크게 백성을 얻도다.",
        "2": "六二(육이) : 육이는\n屯如邅如(둔여전여) : 어렵고 걷기 어려우며\n乘馬班如(승마반여) : 말을 탔다가 내리니,\n匪寇 婚媾(비구혼구) : 도적이 아니면 청혼해 온다.\n女子 貞 不字(녀자정불자) : 여자가 곧아서 시집가지 않다가\n十年乃字(십년내자) : 십년만에 이에 시집가도다.\n字許嫁也(자허가야) : 자는 시집감을 허락하는 것이다\n象曰(상왈) : 상에 이르기를\n六二之難(육이지난) : 육이의 어려움은\n乘剛也(승강야) : 강을 탔음이요,\n十年乃字(십년내자) : '십년만에 시집감'은\n反常也(반상야) : 떳떳함으로 돌아옴이라.",
        "3": "六三(육삼) : 육삼은\n卽鹿無虞(즉록무우) : 사슴을 쫓음에 몰이꾼이 없음이라.\n惟入于林中(유입우림중) : 오직 숲 가운데 들어감이니.\n君子 幾 不如舍(군자기불여사) : 군자가 기미를 보아서 그치는 것만 같지 못하니,\n往吝(왕린) : 가면 인색하리라.\n象曰(상왈) : 상에 가로대,\n卽鹿無虞(즉록무우) : '즉록무우'는\n以從禽也(이종금야) : 새를 쫓음이요,\n君子舍之(군자사지) : 군자가 그치는 것은\n往吝窮也(왕린궁야) : 가면 인색하고 궁함이라.",
        "4": "六四(육사) : 육사는\n乘馬班如(승마반여) : 말을 탔다가 내리니,\n求婚媾(구혼구) : 혼인을 구하여 \n往吉 無不利(왕길무불리) : 가면 길해서 이롭지 않음이 없으리라.\n象曰(상왈) : 상에 가로대,\n求而往(구이왕) : '구하여 감'은\n明也(명야) : 밝게 함이라.",
        "5": "九五(구오) : 구오는\n屯其膏(둔기고) : 고택이 베출어지기 어려우니,\n小貞 吉(소정길) : 조금 바르게 나아가면 길하고\n大貞 凶(대정흉) : 크게 고집하면 흉하리라.\n象曰(상왈) : 상에 가로대,\n屯其膏(둔기고) : '둔기고'는\n施未光也(시미광야) : 베풂이 빛나지 못함이라.",
        "6": "上六(상육) : 상육은\n乘馬班如(승마반여) : 말을 탔다가 내려서\n泣血漣如(읍혈련여) : 피눈물이 줄줄 흐르도다.\n象曰(상왈) : 상에 가로대,\n泣血漣如(읍혈련여) : '읍혈연여'이니\n何可長也(하가장야) : 어찌 가히 오래 가리오"
    },
    "4": {
        "0": "4. 山水蒙(산수몽)\n蒙亨(몽형) : <몽>은 형통하니\n匪我求童蒙(비아구동몽) : 내가 어리고 몽매한 이를 구함이 아니라\n童蒙求我(동몽구아) : 어리고 몽매한 이가 나를 찾아옴이니,\n初筮 告(초서고) : 처음 점치거든 알려주고\n再三 瀆(재삼독) : 두번 세번하면 더럽히는 것이라.\n瀆則不告(독즉불고) : 더럽힌 즉 알려주지 말지니\n利貞(이정) : 바르게 함이 이로우니라.\n象曰(상왈) : 상에 가로대\n山下出泉蒙(산하출천몽) : 산 아래 샘이 솟아나는 것이 몽이니\n君子以果行育德(군자이과행육덕) : 군자가 이로써 과감히 행하며 덕을 기르니라.",
        "1": "初六(초육) : 초육은\n發蒙(발몽) : 몽매함을 일깨우는데\n利用刑人(이용형인) : 사람에게 형벌함을 쓰고서\n用說桎梏(용설질곡) : 질곡을 벗김이 이로우니,\n以往吝(이왕린) : 형벌로써만 해 나가면 인색하리라.\n象曰(상왈) : 상에 가로대,\n利用刑人(이용형인) : '이용형인'은\n以正法也(이정법야) : 법을 바르게 함이라.",
        "2": "九二(구이) : 구이는\n包蒙吉(포몽길) : 몽매함을 감싸면 길하고\n納婦吉(납부길) : 지어미를 들이면 길하리니,\n子克家(자극가) : 자식이 집을 다스리도다.\n象曰(상왈) : 상에 가로대,\n子克家(자극가) : '자극가'는\n剛柔節也(강유절야) : 강과 유가 만남이라.",
        "3": "六三(육삼) : 육삼은\n勿用取女(물용취녀) : 여자를 취하지 말지니,\n見金夫(견금부) : 돈 있는 사내를 보고\n不有躬(불유궁) : 몸을 간수하지 못하면\n無攸利(무유리) : 이로울 바가 없으느라.\n象曰(상왈) : 상에 가로대\n勿用取女(물용취녀) : '물용취녀'는\n行不順也(행불순야) : 행실이 순하지 아니함이라.",
        "4": "六四(육사) : 육사는\n困蒙吝(곤몽린) : 곤궁한 몽이니 인색하도다.\n象曰(상왈) : 상에 가로대,\n困蒙之吝(곤몽지린) : '곤몽지린인'은\n獨遠實也(독원실야) : 홀로 실(陽)에서 멀음이라.",
        "5": "六五(육오) : 육오는\n童蒙吉(동몽길) : 어린 몽매함이니 길하니라.\n象曰(상왈) : 상에 가로대,\n童蒙之吉(동몽지길) : '동몽지길'은\n順以巽也(순이손야) : 순하고 겸손하기 때문이다.",
        "6": "上九(상구) : 상구는\n擊蒙(격몽) : 몽매함을 쳐야하니\n不利爲寇(불리위구) : 도적이 됨은 이롭지 아니하고\n利禦寇(이어구) : 도적을 막음이 이로우니라.\n象曰(상왈) : 상에 가로대,\n利用禦寇(이용어구) : 도적 막는 것이 이로움은\n上下順也(상하순야) : 위와 아래가 순함이라"
    },
    "5": {
    ...
    "25": {
        ...
        "6": "上九(상구) : 상구는\n无妄行有眚(무망행유생) : 무망에 가면 재앙이 있어서\n无攸利(무유리) : 이로운 바가 없느니라.\n象曰(상왈) : 상에 이르기를\n无妄之行(무망지행) : '무망지행'은\n窮之災也(궁지재야) : 궁한 재앙이라"
    },
    "26": {
        "0": "26.山川大畜(산천대축)\n大畜利貞(대축이정) : <대축>은 바르게 함이 이로우니,\n不家食吉(부가식길) : 집에서 먹지 아니하면 길하니\n利涉大川(이섭대천) : 큰 내를 건넘이 이로우니라.\n象曰(상왈) : 상에 이르기를\n天在山中大畜(천재산중대축) : 하늘이 산 가운데 있음이 <대축>이니\n君子以多識前言往行以畜其德(군자이다식전언왕행이축기덕) : 군자가 예전의 말과 지나간 행동을 많이 알아서 그 덕을 쌓느니라.",
        "1": "初九(초구) : 초구는\n有厲利已(유려리이) : 위태로움이 있으리니 그침이 이로우니라.\n象曰(상왈) : 상에 이르기를\n有厲利已(유려이이) : '유려이이'는\n不犯災也(부범재야) : 재앙을 범치 아니함이라.",
        "2": "九二(구이) : 구이는\n輿說輻(여탈복) : 수레의 바퀴살을 벗기도다.\n象曰(상왈) : 상에 이르기를\n輿說輻中(여탈복중) : '여탈복'은 중정함이라.\n无尤也(무우야) : 허물이 없느니라.",
    ...
    "41": {
        ...
        "6": "上九(상구) : 상구는\n弗損益之(불손익지) : 덜지말고 더하면\n无咎貞吉(무구정길) : 허물이 없고 바르게 하여 길하니\n利幽攸往(이유유왕) : 가는 바를 둠이 이로우니\n得臣无家(득신무가) : 신하를 얻음에 집(원근과 친소)이 없으리라.\n象曰(상왈) : 상에 이르기를\n弗損益之(불손익지) : '불손익지'는\n大得志也(대득지야) : 크게 뜻을 얻음이라"
    },
    "42": {
        ...
        "1": "初九(초구) : 초구는\n利用爲大作(이용위대작) : 크게 짓는 것이 이로우니,\n元吉无咎(원길무구) : 크게 길하여야 허물이 없으리라.\n象曰(상왈) : 상에 이르기를\n元吉无咎(원길무구) : '원길무구'는\n下不厚事也(하부후사야) : 아랫 사람은 중대한 일을 못함이라.",
        "2": "六二(육이) : 육이는\n或益之十朋之(혹익지십붕지) : 혹 더하면 열벗이라.\n龜弗克違(귀불극위) : 거북점도 능히 어기지 아니하나\n永貞吉(영정길) : 길이 바르게 하면 길하니,\n王用享于帝吉(왕용향우제길) : 왕이 써 상제께 제사지내더라도 길하리라.\n象曰(상왈) : 상에 이르기를\n或益之(혹익지) : '혹익지'는\n自外來也(자외래야) : 밖으로부터 옴이라.",
        "3": "六三(육삼) : 육삼은\n益之用凶事无咎(익지용흉사무구) : 더함을 흉한일에 씀엔 허물이 없거니와,\n有孚中行告公用圭(유부중행고공용규) : 믿음을 두고 중도를 행하여야 <공>에 고하여 규(도장)를 쓰듯하리라.\n象曰(상왈) : 상에 이르기를\n益用凶事(익용흉사) : '익용흉사'는\n固有之也(고유지야) : 전적으로 맡기는 것이기 때문이다.",
        "4": "六四(육사) : 육사는\n中行告公從(중행고공종) : 중도로 행하면 공(윗라람)에 고함에 윗사람이 따를 것이니,\n利用爲依遷國(이용위의천국) : 의지하며 나라를 옮기는 것이 이로우니라.\n象曰(상왈) : 상에 이르기를\n告公從(고공종) : '고공종'은\n以益志也(이익지야) : 더하려는 뜻으로 써라.",
        "5": "九五(구오) : 구오는\n有孚惠心(유부혜심) : 은혜를 베푸는 마음을 지성으로 하는 것이라.\n勿問元吉(물문원길) : 묻지 않아도 크게 길하니,\n有孚惠我德(유부혜아덕) : 믿음을 두어 내덕을 은혜롭게 여기리라.\n象曰(상왈) : 상에 이르기를\n有孚惠心(유부혜심) : '유부혜심'은\n勿問之矣(물문지의) : 물을 것도 없으며,\n惠我德(혜아덕) : '혜아덕'은\n大得志也(대득지야) : 크게 뜻을 얻음이라.",
        "6": "上九(상구) : 상구는\n莫益之(막익지) : 더하는 이가 없느니라.\n或擊之(혹격지) : 혹 치리니,\n立心勿恒凶(입심물항흉) : 마음을 세워 항상 하지 못하니 흉하니라.\n象曰(상왈) : 상에 이르기를\n莫益之(막익지) : '막익지'는\n偏辭也(편사야) : 자기 욕심에 너무 치우쳤다는 말이요,\n或擊之(혹격지) : '혹격지'는\n自外來也(자외래야) : 밖으로부터 옴이라"
    },
    "43": {
        "0": "43.澤天夬(택천쾌)\n夬(쾌) : <쾌>는\n揚于王庭(양우왕정) : 왕의 뜰에서 드날림이니,\n孚號有厲(부호유려) : 성심으로 호령해서 위태로운 듯 조심하니라.\n告自邑(고자읍) : 읍으로부터 고하고(자기 자신부터 바르게 하고),\n不利卽戎(불리즉융) : 군사를 쓰는 것은 이롭지 아니하며,\n利有攸往(이유유왕) : 가는 바를 둠이 이로우니라.\n象曰(상왈) : 상에 이르기를\n澤上於天夬(택상어천쾌) : 못이 하늘에 오르는 것이 쾌괘의 괘상이니\n君子以施祿及下(군자이시록급하) : 군자가 녹을 베풀음이 아래에 미치며,\n居德則忌(거덕칙기) : 덕에 거처하여 금기사항을 법제화하느니라.",
        "1": "初九(초구) : 초구는\n壯于前趾(장우전지) : 발꿈치가 나아가는데 용감함이니,\n往不勝爲咎(왕부승위구) : 가서 이기지 못하면 허물이 되리라.\n象曰(상왈) : 상에 이르기를\n不勝而往咎也(부승이왕구야) : 이기지 못하면서 가는 것이 허물이라.",
        "2": "九二(구이) : 구이는\n惕號(척호) : 두렵게 부르짖음이니,\n莫夜有戎勿恤(막야유융물휼) : 깊은 밤에 군사가 있더라도 근심치 말지로다.\n象曰(상왈) : 상에 이르기를\n有戎勿恤(유융물휼) : '유융물휼'은\n得中道也(득중도야) : 중도를 얻음이라.",
        "3": "九三(구삼) : 구삼은\n壯于頄有凶(장우구유흉) : 광대뼈에 장해서 흉함이 있고\n獨行遇雨(독행우우) : 홀로 행하여 비를 만나니.\n君子夬夬(군자쾌쾌) : 군자는 결단할 것을 결단하는지라,\n若濡有无咎(약유유무구) : (소인을 싫어하기를 비에)젖는듯 해서 성냄이 있으면 허물이 없다.\n象曰(상왈) : 상에 이르기를\n君子夬夬(군자쾌쾌) : '군자쾌쾌'라\n終无咎也(종무구야) : 마침내 허물이 없느니라.",
        "4": "九四(구사) : 구사는\n臀无膚其行次且(둔무부기행자저) : 볼기에 살이 없으며 그 행함이 머뭇거리니,\n牽羊悔亡(견양회망) : 양을 이끌면 뉘우침이 없으련마는\n聞言不信(문언부신) : 말을 듣더라도 믿지 않으리라.\n象曰(상왈) : 상에 이르기를\n其行次且(기행차차) : '기행차차'는\n位不當也(위불당야) : 자리가 당치 않음이요,\n聞言不信(문언부신) : '문언부신'은\n聰不明也(총부명야) : 귀밝음이 밝지 않음이라.",
    ...
    "46": {
        ...
        "6": "上六(상육) : 상육은\n冥升(명승) : 어둡게 오름이니,\n利于不息之貞(이우부식지정) : 쉬지 않는 바름이 이로우니라.\n象曰(상왈) : 상에 이르기를\n冥升在上(명승재상) : '명승'이 위에 있으니,\n消不富也(소부부야) : 사라져 부유하지 못함이라"
    },
    "47": {
        ...
        "3": "六三(육삼) : 육삼은\n困于石(곤우석) : 돌에 곤란하며\n據于蒺蔾(거우질려) : 가시에 웅거함이라.\n入于其宮(입우기궁) : 그 집에 들어가더라도\n不見其妻(부견기처) : 그 처를 보지 못하니 흉하도다.\n象曰(상왈) : 상에 이르기를\n據于蒺蔾(거우질려) : '거우질려'는\n乘剛也(승강야) : 강을 탐이요,\n入于其宮不見其妻(입우기궁부견기처) : 제집에 들어가니 아내를 보지 못한다는 것은\n不祥也(부상야) : 상서롭지 못함이라.",
        "4": "九四(구사) : 구사는\n來徐徐(래서서) : 오는 것이 느릿느릿한 것은\n困于金車(곤우금거) : 쇠수레에 곤하기 때문이니\n吝有終(린유종) : 인색하나 마침이 있으리라.\n象曰(상왈) : 상에 이르기를\n來徐徐(래서서) : '래서서'는\n志在下也(지재하야) : 뜻이 아래에 있음이니,\n雖不當位(수불당위) : 비록 자리가 마땅치 않으나\n有與也(유여야) : 더불음이 있느니라.",
    ...
    "50": {
        "0": "50.火風鼎(화풍정)\n鼎(정) : <정>은\n元(吉)亨(원(길)형) : 크게 (길하여) 형통하니라.\n象曰(상왈) : 상에 이르기를\n木上有火鼎(목상유화정) : 나무위에 불이 있는 것이 정괘의 괘상이니,\n君子以正位凝命(군자이정위응명) : 군자가 자리를 바로해서 천명을 완수한다.",
        "1": "初六(초육) : 초육은\n鼎顚趾(정전지) : 솥이 발꿈치가 엎어지나\n利出否(이출비) : 비색한 것을 내놓는 것이 이로우니,\n得妾以其子无咎(득첩이기자무구) : 첩을 얻으면 그 자식으로써 허물이 없어지리라.\n象曰(상왈) : 상에 이르기를\n鼎折趾未悖也(정전지미패야) : '정전지'나 거스리지 아니함이요,\n利出否以從貴也(이출비이종귀야) : '이출비'는 귀한 것을 좇음이라.",
        "2": "九二(구이) : 구이는\n鼎有實(정유실) : 솥에 실물이 있으나\n我仇有疾(아구유질) : 내 원수는 병이 들었으니,\n不我能卽吉(부아능즉길) : 내게 다가오지 못하게 하면 길하리라.\n象曰(상왈) : 상에 이르기를\n鼎有實(정유실) : '정유실'이나\n愼所之也(신소지야) : 가는 바를 삼가야 한다\n我仇有疾(아구유질) : '아구유질'하니\n終无尤也(종무우야) : 마침내 허물이 없어지리라.",
        "3": "九三(구삼) : 구삼은\n鼎耳革(정이혁) : 솥귀가 고쳐서\n其行塞(기행색) : 그 행함이 막혀서\n稚膏不食(치고부식) : 꿩의 기름을 먹지 못하나,\n方雨(방우) : 바야흐로 비 내려서\n虧悔終吉(휴회종길) : 부족하게 되었던 뉘우침이 마침내 길하게 되리라.\n象曰(상왈) : 상에 이르기를\n鼎耳革(정이혁) : '정이혁'은\n失其義也(실기의야) : 그 뜻을 잃음이라.",
    ...
    "53": {
        ...
        "4": "六四(육사) : 육사는\n鴻漸于木(홍점우목) : 기러기가 나무에 나아감이니,\n或得其桷无咎(혹득기무구) : 혹 그 평평한 가지를 얻으면 허물이 없으리라.\n象曰(상왈) : 상에 이르기를\n或得其桷(혹득기각) : '혹득기각'은\n順以巽也(순이손야) : 순하고 겸손함이라.",
